      ...
      <AppProvider>
        ...
        >
          ...
          {this.renderAccount()}
            ...
            <Layout.Section>
              <FooterHelp>For more details on Polaris, visit our <Link url="https://polaris.redhio.com">styleguide</Link>.</FooterHelp>
            </Layout.Section>
    ...
    return (
      ...
      >
        <AccountConnection
          ...
          termsOfService={<p>By clicking Connect, you are accepting Sample’s <Link url="https://polaris.redhio.com">Terms and Conditions</Link>, including a commission rate of 15% on sales.</p>}
        />
      </Layout.AnnotatedSection>
    );
  }
